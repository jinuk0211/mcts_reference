# mcts_reference
The previous reasoning step is wrong and let’s rethink it again.

question-dependent reasoning tree S
with the correct reasoning path Y
{Q,Y,S}
![Uploading image.png…]()
```python
import copy
...
if __name__ == "__main__":
    ...
    torch.save(nnet.state_dict(), f'./models/{config["game"]}best.pt')import copy
from joblib import Parallel, delayed
import matplotlib.pyplot as plt
import multiprocessing
import numpy as np
